...
If you do not find the desired icon in the [Icon](https://github.com/mgbq/nx-admin/tree/master/src/icons/svg) of this project, you can select and generate your own business icon library on [iconfont.cn](http://iconfont.cn/)and use it again. Or other svg icon website, download svg and put it in this folder.
...
:::tip
If you encounter an incorrect icon color, you can refer to this[issue](https://github.com/mgbq/nx-admin/issues/330)
:::
