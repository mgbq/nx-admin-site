...
> Code: [@/views/layout/components/Sidebar](https://github.com/mgbq/nx-admin/tree/master/src/views/layout/components/Sidebar)

This also modify many default sidebar styles of `element-ui`. All css can be found in [@/styles/sidebar.scss](https://github.com/mgbq/nx-admin/blob/master/src/styles/sidebar.scss) and can be modified to suit your needs.
...
> Corresponding code: [@/components/Breadcrumb](https://github.com/mgbq/nx-admin/blob/master/src/components/nx-breadcrumb/index.vue)
...
::: tip Code
[@/components/Sidebar](https://github.com/mgbq/nx-admin/blob/master/src/views/layout/components/Sidebar/index.vue)
:::
