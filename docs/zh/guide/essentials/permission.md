...
在 [基于Vue2.0实现后台系统权限控制(登录权限篇)](https://juejin.im/post/5a97e41bf265da23a048fa20) 这篇文章中其实已经详细介绍过了。
...
封装了一个指令权限，能简单快速的实现按钮级别的权限判断。 [v-permission](https://github.com/mgbq/nx-admin/tree/master/src/directive/permission)
