...
所有的配置文件都在 [.eslintrc.js](https://github.com/mgbq/nx-admin/blob/master/.eslintrc.js) 中。
...
如果你实在是不想使用 ESLint 校验，只要找到 [config/index.js](https://github.com/mgbq/nx-admin/blob/master/build/webpack.base.conf.js) 文件。
...
:::tip
[showEslintErrorsInOverlay](https://github.com/mgbq/nx-admin/blob/master/config/index.js) 这个变量可以控制错误提示是否需要在浏览器界面中提示。
:::
